...
parser.add_argument('--image_path', default=r'D:\bladeThird\aug\val\images',type=str, help="path of images")
parser.add_argument('--label_path', default=r'D:\bladeThird\aug\val\labels',type=str, help="path of labels .txt")
parser.add_argument('--save_path', type=str,default=r'D:\bladeThird\aug\val\coco\val.json', help="if not split the dataset, give a path to a json file")
