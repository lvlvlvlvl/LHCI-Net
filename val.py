...
if __name__ == '__main__':
    model_path = r'D:\algorithms\RTDETR-mg\runs\prune\M-speedup=1.6-slim -finetune\weights\best.pt'
    model = RTDETR(model_path) # 选择训练好的权重路径
    result = model.val(data=r'D:\algorithms\RTDETR-20251122\RTDETR-mg\dataset\bladeThird.yaml',
                      ...
                      project='runs/val',
                      name='M-speedup=1.6-slim -finetune',
                      )
